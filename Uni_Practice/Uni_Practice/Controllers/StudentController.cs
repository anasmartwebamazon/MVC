...
namespace Uni_Practice.Controllers
{
    public class StudentController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="StudentId,RegistrationNo,Name,Email,Address,DepartmentId")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="StudentId,RegistrationNo,Name,Email,Address,DepartmentId")] Student student)
        {
            if (ModelState.IsValid)
            {
