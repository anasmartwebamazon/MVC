...
namespace Uni_Practice.Controllers
{
    public class TeacherController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="TeacherId,Name,Designation,Email,CreditToBeTaken,DepartmentId")] Teacher teacher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="TeacherId,Name,Designation,Email,CreditToBeTaken,DepartmentId")] Teacher teacher)
        {
            if (ModelState.IsValid)
            {
                teacher.RemainingCredit = teacher.CreditToBeTaken;
